...
namespace osu.Game.Rulesets.Catch.Difficulty
{
    public class CatchDifficultyCalculator : DifficultyCalculator
    {
        ...
        private const double star_rating_offset = 0.6061617209075998;
        private const double star_rating_scale = 0.9912181489090317;
        private const double mid_star_rating_threshold = 1.5347326104460917;
        private const double mid_star_rating_scale = -0.5544134600358255;
        private const double high_star_rating_threshold = 2.6916292289613537;
        private const double high_star_rating_scale = 0.9369678078452697;
        private const double post_star_rating_offset = 0.24179108392127396;
        private const double post_star_rating_scale = 1.4090292423715494;
        private const double post_mid_star_rating_threshold = 3.303408718020791;
        private const double post_mid_star_rating_scale = -0.414397956836211;
        private const double post_high_star_rating_threshold = 1.5878749678504038;
        private const double post_high_star_rating_scale = 0.3016351069385136;
        private const double final_star_rating_offset = 0.06210307713401454;
        private const double final_star_rating_scale = 1.1354893692805272;
        private const double final_mid_star_rating_threshold = 2.478072285151301;
        private const double final_mid_star_rating_scale = 0.17522636841207967;
        private const double final_high_star_rating_threshold = 6.9064555566271055;
        private const double final_high_star_rating_scale = -0.5690614742466313;
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills)
        {
            ...
            double blendedMovement = 0.90 * movement + 0.10 * difficultyMass;
